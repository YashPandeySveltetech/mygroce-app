                ...
                >
                  ...
                  <div className="flex space-x-3 items-center">
                    ...
                    <button
                      ...
                      type="button"
                      className={`hover:text-qgreen w-6 h-6 ${cardViewStyle === "col" ? "primary-text" : "text-qgray"
                        }`}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <button
                      ...
                      type="button"
                      className={`hover:text-qgreen w-6 h-6 ${cardViewStyle === "row" ? "primary-text" : "text-qgray"
                        }`}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
