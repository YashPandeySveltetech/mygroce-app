...
function index() {
	...
	const updateProfile = async () => {
		setSelectedCountries(Country.getAllCountries());
		setSelectedStates(State.getStatesOfCountry('IN'));
		setSelectedCities(City.getCitiesOfState('IN', 'UP'));
		...
		if (true) {
          ...
          setProfile({
              ...
              country_id: res?.data?.data?.country,
              state_id: res?.data?.data?.state,
              city_id: res?.data?.data?.city,
              zip_code: res?.data?.data?.pincode,
              address: 'India',
