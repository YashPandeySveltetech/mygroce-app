...
import { LocalStorageSetItem } from "../../../../utils/commonFunction";
  ...
  const doSignup = async () => {
    ...
    await apiRequest
      ...
      .then((res) => {
        ...
        LocalStorageSetItem('token',{"access_token":res.data.token})
                  ...
                  <div className="input-area">
                    ...
                    <div className="input-item mb-5">
                      <InputCom
                        ...
                        min="1" 
                        max="10"
                        error={!!(errors && Object.hasOwn(errors, "mobile"))}
                        inputHandler={(e) => setMobile(e.target.value)}
                      />
                      {errors && Object.hasOwn(errors, "mobile") ? (
                        <span className="text-sm mt-1 text-qred">
                          {errors.mobile[0]}
                        </span>
                      ) : (
